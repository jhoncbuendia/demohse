...
(function (e, t, n, r) {
    ...
    Foundation.libs.slider = {
        ...
        calculate_position: function (t, n) {
            var r = this, i = e.extend({}, r.settings, r.data_options(t.parent())), s = e.data(t[0], "handle_w"), o = e.data(t[0], "handle_o"), u = e.data(t[0], "bar_w"), a = e.data(t[0], "bar_o");
            requestAnimationFrame(function () {
                var e = r.limit_to((n - a) / u, 0, 1), s = r.normalized_value(e, i.start, i.end, i.step);
                r.set_ui(t, s)
            })
        },
        set_ui: function (t, n) {
            var r = e.extend({}, this.settings, this.data_options(t.parent())), i = e.data(t[0], "handle_w"), s = e.data(t[0], "bar_w"), o = this.normalized_percentage(n, r.start, r.end), u = o * (s - i) - 1, a = o * 100;
        ...
        normalized_value: function (e, t, n, r) {
            var i = n - t, r = r, s = e * i, o = (s - s % r) / r, u = s % r, a = u >= r * .5 ? r : 0;
            return o * r + a
        },
        ...
        set_initial_position: function (t) {
            var n = e.data(t.children(".range-slider-handle")[0], "settings"), r = n.initial ? n.initial : Math.floor((n.end - n.start) * .5 / n.step) * n.step, i = t.children(".range-slider-handle");
            this.set_ui(i, r)
        },
    ...
    Foundation.libs.dropdown = {
        ...
        clear_idx: function () {
            ...
            this.rule_idx && (e.deleteRule(this.rule_idx), e.deleteRule(this.rule_idx),
    ...
    Foundation.libs.clearing = {
        ...
        assemble: function (t) {
            ...
            var r = this.S("#foundationClearingHolder"), i = n.data(this.attr_name(!0) + "-init"), s = n.detach(), o = {
                grid: '<div class="carousel">' + s[0].outerHTML + "</div>",
                viewing: i.templates.viewing
            }, u = '<div class="clearing-assembled"><div>' + o.viewing + o.grid + "</div></div>", a = this.settings.touch_label;
        ...
        open: function (t, r, i) {
            ...
            var s = this, o = e(n.body), u = i.closest(".clearing-assembled"), a = e("div", u).first(), f = e(".visible-img", a), l = e("img", f).not(t), c = e(".clearing-touch-label", ".clearing-blackout"), h = !1;
            l.error(function () {
                h = !0
    ...
    var i = function () {
        ...
        if (r.hasClass(i.slides_container_class))
            return this;
        var s = this, a, f = r, l, c, h, p = 0, d, v = !1;
    ...
    Foundation.libs.topbar = {
        ...
        events: function (n) {
            ...
            i(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar",function (e) {
                ...
                var t = i(this), n = i(e.target), s = t.closest("[" + r.attr_name() + "]"), o = s.data(r.attr_name(!0) + "-init");
                if (n.data("revealId")) {
                    r.toggle();
                    return
                }
                ...
                if (i.deep_linking) {
                    ...
                    if (s != "") {
                        ...
                        if (o.hasClass("content") && o.parent().hasClass("tab-content"))
                            t.toggle_active_tab(e("[" + t.attr_name() + "] > dd > a[href=" + s + "]").parent());
                        else {
                        ...
                        for (var a in t.default_tab_hashes)
                            t.toggle_active_tab(e("[" + t.attr_name() + "] > dd > a[href=" + t.default_tab_hashes[a] + "]").parent())
                }
            })
        },
    ...
    Foundation.libs.abide = {
        ...
        check_validation_and_apply_styles: function (t) {
            var n = t.length, r = [];
            while (n--) {
                var i = t[n][0], s = t[n][2], o = i.value, u = this.S(i).parent(), a = i.getAttribute(this.add_namespace("data-abide-validator")), f = i.type === "radio", l = i.type === "checkbox", c = this.S('label[for="' + i.getAttribute("id") + '"]'), h = s ? i.value.length > 0 : !0, p, d;
